      ...
      child: Column(
        children: [
          ...
          CtaCard(
            iconSvg:
                '''<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22S22 17.52 22 12S17.52 2 12 2ZM17 13H13V17H11V13H7V11H11V7H13V11H17V13Z" fill="white"/>
            </svg>''',
            backgroundColor: const Color(0xFF00A63E),
            title: 'Smart Property Exchange Network',
            description:
                'Connect with property owners looking for similar exchanges. No agents, no commissions.',
            buttonText: 'Learn More',
            buttonTextColor: const Color(0xFF00A63E),
          ),
        ],
      ),
    );
