...
class _PropertyListScreenState extends State<PropertyListScreen> {
  ...
  Future<void> _saveProperty(String propertyId) async {
    if (propertyId.isEmpty) return;
    setState(() => _isSaving = true);
    try {
      final authToken = _token ?? token;
      final uri = Uri.parse('${baseUrl}api/saved/add');
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Property saved to wishlist!'),
          ),
        );
        setState(() {
                                                                    ...
                                                                    return ResidentialDetailScreen(
                                                                      property:
                                                                        ...
                                                                        location: propertyList[index]
                                                                            ...
                                                                            .fullAddress,
                                                                        bedrooms:
                                                                            propertyList[index].layout?.bedrooms ??
                                                                                0,
                                                                        bathrooms:
                                                                            propertyList[index].layout?.bathrooms ??
                                                                                0,
                                                                        sqft: propertyList[index].sqft?.toInt() ??
                                                                            0,
                                                                        description:
                                                                            propertyList[index].about ??
                                                                                "",
                                                                        builtYear:
                                                                            "2018",
                                                                        features:
                                                                            propertyList[index].amenities ??
                                                                                [],
                                                                      ),
                                                                      colorcode:
                                                                          widget
